...
local inCombat = {
	...
	-- Def cooldowns // heals
		{ "48792", { "toggle.defcd", "@mtsLib.ConfigUnitHp('DkBloodIbfPercentage", "player')" }, "player')" }, -- Icebound Fortitude
		{ "55233", { "toggle.defcd", "@mtsLib.ConfigUnitHp('vbPercentage", "player')" }}, -- Vampiric Blood
		{ "48743", { "toggle.defcd", "@mtsLib.ConfigUnitHp('BloodDpPercentage', 'player')" }}, -- Death Pact
		...
		{ "48982", { "toggle.defcd", "@mtsLib.ConfigUnitHp('runeTapPercentage" }}, -- rune tap
